...
This service package now exposes only the OctoBus Connect verified RPC `ListDomain` in proto/rpcdef. Other vendor APIs are intentionally left out of proto/rpcdef until corresponding OctoBus runtime evidence is added.
