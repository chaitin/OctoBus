...
export const READ_ONLY_APIS = [
  ...
  { methodName: 'TamperproofQuotaQuery', api: 'tamperproofQuotaQuery', httpMethod: 'POST', path: '/v1/tamperProof/quota/query/*/*' },
  { methodName: 'TamperproofQuotaOverview2', api: 'tamperproofQuotaOverview2', httpMethod: 'GET', path: '/v1/tamperProof/quota/overview' },
  ...
  { methodName: 'QuotaList', api: 'quotaList', httpMethod: 'POST', path: '/v1/quota/quotaList/*/*' },
  { methodName: 'GetUnBindQuotaVersionList', api: 'getUnBindQuotaVersionList', httpMethod: 'POST', path: '/v1/quota/unBindList' },
  { methodName: 'GetPayQuotaHostsByAz', api: 'getPayQuotaHostsByAz', httpMethod: 'POST', path: '/v1/quota/quotaHosts' },
  { methodName: 'GetQuotaVersionHostList', api: 'getQuotaVersionHostList', httpMethod: 'POST', path: '/v1/quota/hostList' },
  ...
  { methodName: 'V1indexisSign', api: 'v1indexisSign', httpMethod: 'GET', path: '/v1/index/isSign' },
