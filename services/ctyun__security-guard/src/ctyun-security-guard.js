...
export const READ_ONLY_APIS = [
  ...
  { methodName: 'GetHostsByAz', api: 'getHostsByAz', httpMethod: 'POST', path: '/v1/host/page' },
  { methodName: 'GetHostByAz', api: 'getHostByAz', httpMethod: 'GET', path: '/v1/host/az' },
  { methodName: 'AnnouncementAffectedHostDetail', api: 'announcementAffectedHostDetail', httpMethod: 'POST', path: '/v1/announcement/affectedHostDetail' },
  { methodName: 'V1instrusionwhitelisthostlist', api: 'v1instrusionwhitelisthostlist', httpMethod: 'POST', path: '/v1/instrusion/whitelist/hostlist' },
  { methodName: 'ScaEventIsrunCheck', api: 'scaEventIsrunCheck', httpMethod: 'POST', path: '/v1/sca/event/isrun/check' },
  { methodName: 'GetAgentKey', api: 'getAgentKey', httpMethod: 'GET', path: '/v1/host/getAgentKey' },
  { methodName: 'BusinessGroupQuery22', api: 'businessGroupQuery22', httpMethod: 'POST', path: '/v1/business/group/query' },
  { methodName: 'ScaCheckWhiteList', api: 'scaCheckWhiteList', httpMethod: 'POST', path: '/v1/sca/check/whiteList/*/*' },
  { methodName: 'TamperproofConfigQueryBackup', api: 'tamperproofConfigQueryBackup', httpMethod: 'POST', path: '/v1/tamperProof/config/queryBackup' },
  { methodName: 'HostAgentIpList', api: 'hostAgentIpList', httpMethod: 'POST', path: '/v1/host/agentIpList' },
  { methodName: 'GetVulWhiteList', api: 'getVulWhiteList', httpMethod: 'POST', path: '/v1/vulnerability/whitelist' },
  { methodName: 'TamperproofQueryFilterHostList', api: 'tamperproofQueryFilterHostList', httpMethod: 'POST', path: '/v1/host/queryFilterHostList/*/*' },
  { methodName: 'AppProofQueryList', api: 'appProofQueryList', httpMethod: 'POST', path: '/v1/appProof/queryList' },
  { methodName: 'TamperproofQueryRemoteServerList', api: 'tamperproofQueryRemoteServerList', httpMethod: 'POST', path: '/v1/tamperProof/query/remoteServerList/*/*' },
  { methodName: 'AnnouncementAffectedHostsList1', api: 'announcementAffectedHostsList1', httpMethod: 'POST', path: '/v1/announcement/affectedHostsList' },
  { methodName: 'GetPeriodicScanConf', api: 'getPeriodicScanConf', httpMethod: 'GET', path: '/v1/vulnerability/conf' },
  { methodName: 'SyncTime', api: 'syncTime', httpMethod: 'GET', path: '/v1/sync/time' },
  { methodName: 'VulnerabilityGetUpgradeSource', api: 'vulnerabilityGetUpgradeSource', httpMethod: 'GET', path: '/v1/vulnerability/getUpgradeSource' },
  { methodName: 'SetFocusQueryList', api: 'setFocusQueryList', httpMethod: 'GET', path: '/v1/setFocus/queryList' },
];
